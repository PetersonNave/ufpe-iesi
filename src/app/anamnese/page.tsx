  ...
  if (!patientId) {
    return (
      <div className={styles.container}>
        <p>Link inválido. Identificação do paciente não encontrada.</p>
      </div>
    );
  }
    ...
    <div className={styles.container}>
      <div className={styles.card}>
        <div className={styles.header}>
          ...
          <p>
            Olá, <strong>{patientName || "Paciente"}</strong>. Por favor,
            preencha as informações abaixo para adiantar seu atendimento.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className={styles.form}>
          ...
          <div className={styles.fieldGroup}>
            <label>
              Histórico de Saúde (Doenças crônicas, cirurgias passadas)
            </label>
            <textarea
              name="historico"
              rows={3}
          ...
          <div className={styles.fieldGroup}>
            <label>
              Nível de dor hoje (0 = Sem dor, 10 = Pior dor possível)
            </label>
